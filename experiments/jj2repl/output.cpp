...
uint jjCRC32(const jjSTREAM &put, uint crc = 0) {
	return 0;
}
...
array<jjLAYER*>* jjLayerOrderGet() {
	return new array<jjLAYER>();
}

bool jjLayerOrderSet(const array<jjLAYER*>& order) {
	return true;
}
...
bool jjRegexMatch(const string & text, const string & expression, array<string> &out results, bool ignoreCase = false) {
	return true;
}
...
bool jjRegexSearch(const string & text, const string & expression, array<string> &out results, bool ignoreCase = false) {
	return true;
}
...
void jjSpriteModeSetMapping(uint8 index, const array<uint8> &dexMapping, const jjPAL & rgbMapping) {
	return ;
}

void jjSpriteModeSetMapping(uint8 index, const array<uint8> &dexMapping) {
	return ;
}
...
bool jjZlibCompress(const jjSTREAM &put, jjSTREAM &out output) {
	return true;
}

bool jjZlibUncompress(const jjSTREAM &put, jjSTREAM &out output, uint size) {
	return true;
}
